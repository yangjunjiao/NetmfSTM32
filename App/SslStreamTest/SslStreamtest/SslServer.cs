...
namespace Microsoft.SPOT.Platform.Tests
{
    public class SslServer
    {
        ...
        //{
        //    Debug.Print("Cipher: {0} strength {1}", stream.CipherAlgorithm, stream.CipherStrength);
        //    Debug.Print("Hash: {0} strength {1}", stream.HashAlgorithm, stream.HashStrength);
        //    Debug.Print("Key exchange: {0} strength {1}", stream.KeyExchangeAlgorithm, stream.KeyExchangeStrength);
        //    Debug.Print("Protocol: {0}", stream.SslProtocol);
        //}
        //public void DisplaySecurityServices(SslStream stream)
        //{
        //    Debug.Print("Is authenticated: {0} as server? {1}", stream.IsAuthenticated, stream.IsServer);
        //    Debug.Print("IsSigned: {0}", stream.IsSigned);
        //    Debug.Print("Is Encrypted: {0}", stream.IsEncrypted);
        //}
        //public void DisplayStreamProperties(SslStream stream)
        //{
        //    Debug.Print("Can read: {0}, write {1}", stream.CanRead, stream.CanWrite);
        //    Debug.Print("Can timeout: {0}", stream.CanTimeout);
        //}
        //public void DisplayCertificateInformation(SslStream stream)
        //{
        //    Debug.Print("Certificate revocation list checked: {0}", stream.CheckCertRevocationStatus);

        //    X509Certificate localCertificate = stream.LocalCertificate;
        //    if (stream.LocalCertificate != null)
        //    {
        //        Debug.Print("Local cert was issued to {0} and is valid from {1} until {2}.",
        ...
        //    else
        //    {
        //        Debug.Print("Local certificate is null.");
        //    }
        //    // Display the properties of the client's certificate.
        //    X509Certificate remoteCertificate = stream.RemoteCertificate;
        //    if (stream.RemoteCertificate != null)
        //    {
        //        Debug.Print("Remote cert was issued to {0} and is valid from {1} until {2}.",
        ...
        //    else
        //    {
        //        Debug.Print("Remote certificate is null.");
        //    }
        //}
