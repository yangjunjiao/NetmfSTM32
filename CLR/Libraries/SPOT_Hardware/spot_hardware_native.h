...
{
    static const int FIELD_STATIC__s_hwProvider = 5;
...
{
    static const int FIELD_STATIC__s_CurrentPowerLevel = 6;
    static const int FIELD_STATIC__OnSleepChange = 7;
    static const int FIELD_STATIC__OnPowerLevelChange = 8;
    static const int FIELD_STATIC__OnRebootEvent = 9;
