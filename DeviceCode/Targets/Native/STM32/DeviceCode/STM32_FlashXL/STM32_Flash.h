...
struct STM32_Flash_Driver
{
	...
	static BOOL WriteBank1(CHIP_WORD* ChipAddress,CHIP_WORD* EndAddress, CHIP_WORD *pBuf);
	static BOOL WriteBank2(CHIP_WORD* ChipAddress,CHIP_WORD* EndAddress, CHIP_WORD *pBuf);
	static BOOL EraseBlockBank1(ByteAddress Sector);
	static BOOL EraseBlockBank2(ByteAddress Sector);
