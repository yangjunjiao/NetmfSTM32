...
void eth_initEthGpio() 
{
    ...
    CPU_GPIO_DisablePin(Eth_Mii_Crs, RESISTOR_DISABLED, 0,
            (GPIO_ALT_MODE)ETH_AF11);
    CPU_GPIO_DisablePin(Eth_Mii_Col, RESISTOR_DISABLED, 0,
            (GPIO_ALT_MODE)ETH_AF11);
    CPU_GPIO_DisablePin(Eth_Mii_Rxd2, RESISTOR_DISABLED, 0,
            (GPIO_ALT_MODE)ETH_AF11);
    CPU_GPIO_DisablePin(Eth_Mii_Rxd3, RESISTOR_DISABLED, 0,
            (GPIO_ALT_MODE)ETH_AF11);
    CPU_GPIO_DisablePin(Eth_Mii_Txd3, RESISTOR_DISABLED, 0,
            (GPIO_ALT_MODE)ETH_AF11);
    CPU_GPIO_DisablePin(Eth_Mii_Rxer, RESISTOR_DISABLED, 0,
            (GPIO_ALT_MODE)ETH_AF11);
    CPU_GPIO_DisablePin(Eth_Mii_Txen, RESISTOR_DISABLED, 0,
            (GPIO_ALT_MODE)ETH_AF11);
    CPU_GPIO_DisablePin(Eth_Mii_Txd0, RESISTOR_DISABLED, 0,
            (GPIO_ALT_MODE)ETH_AF11);
    CPU_GPIO_DisablePin(Eth_Mii_Txd1, RESISTOR_DISABLED, 0,
            (GPIO_ALT_MODE)ETH_AF11);
    CPU_GPIO_DisablePin(Eth_Mii_Rxclk, RESISTOR_DISABLED, 0,
            (GPIO_ALT_MODE)ETH_AF11);
    CPU_GPIO_DisablePin(Eth_Mdio, RESISTOR_DISABLED, 0,
            (GPIO_ALT_MODE)ETH_AF11);
    CPU_GPIO_DisablePin(Eth_Mii_Rxdv, RESISTOR_DISABLED, 0,
            (GPIO_ALT_MODE)ETH_AF11);
    CPU_GPIO_DisablePin(Eth_Mdc, RESISTOR_DISABLED, 0, 
            (GPIO_ALT_MODE)ETH_AF11);
    CPU_GPIO_DisablePin(Eth_Mii_Txd2, RESISTOR_DISABLED, 0,
            (GPIO_ALT_MODE)ETH_AF11);
    CPU_GPIO_DisablePin(Eth_Mii_Txclk, RESISTOR_DISABLED, 0,
            (GPIO_ALT_MODE)ETH_AF11);
    CPU_GPIO_DisablePin(Eth_Mii_Rxd0, RESISTOR_DISABLED, 0,
            (GPIO_ALT_MODE)ETH_AF11);
    CPU_GPIO_DisablePin(Eth_Mii_Rxd1, RESISTOR_DISABLED, 0,
            (GPIO_ALT_MODE)ETH_AF11);
}
