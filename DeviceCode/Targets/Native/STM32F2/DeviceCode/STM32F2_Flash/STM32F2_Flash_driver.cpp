...
#define FLASH_CR_PSIZE_BITS FLASH_CR_PSIZE_0 // 16 bit programming
    ...
    static const int STM32F2_FLASH_KEY1 = 0x45670123;
    static const int STM32F2_FLASH_KEY2 = 0xcdef89ab;
...
//--//
    ...
    //
BOOL __section(SectionForFlashOperations)STM32F2_Flash_Driver::ChipInitialize( void* context )
{
    ...
    //
BOOL __section(SectionForFlashOperations)STM32F2_Flash_Driver::ChipUnInitialize( void* context )
{
    NATIVE_PROFILE_HAL_DRIVERS_FLASH();
    return TRUE;
}
    ...
    //
const BlockDeviceInfo* __section(SectionForFlashOperations)STM32F2_Flash_Driver::GetDeviceInfo( void* context )
{
    ...
    //   
BOOL  __section(SectionForFlashOperations)STM32F2_Flash_Driver::Read( void* context, ByteAddress StartSector, UINT32 NumBytes, BYTE * pSectorBuff)
{
    ...
    //   This function reads the number of sectors specified from the device.
    //   
BOOL __section(SectionForFlashOperations)STM32F2_Flash_Driver::Write(void* context, ByteAddress Address, UINT32 NumBytes, BYTE * pSectorBuff, BOOL ReadModifyWrite)
{
    ...
    if (FLASH->CR & FLASH_CR_LOCK) { // unlock
        FLASH->KEYR = STM32F2_FLASH_KEY1;
        FLASH->KEYR = STM32F2_FLASH_KEY2;
    }
...
BOOL __section(SectionForFlashOperations)STM32F2_Flash_Driver::Memset(void* context, ByteAddress Address, UINT8 Data, UINT32 NumBytes)
{
    NATIVE_PROFILE_PAL_FLASH();
...
BOOL __section(SectionForFlashOperations)STM32F2_Flash_Driver::GetSectorMetadata(void* context, ByteAddress SectorStart, SectorMetadata* pSectorMetadata)
{
    // no metadata
    return FALSE;
}

BOOL __section(SectionForFlashOperations)STM32F2_Flash_Driver::SetSectorMetadata(void* context, ByteAddress SectorStart, SectorMetadata* pSectorMetadata)
{
    // no metadata
    return FALSE;
}
    ...
    //    
BOOL __section(SectionForFlashOperations)STM32F2_Flash_Driver::IsBlockErased( void* context, ByteAddress BlockStart, UINT32 BlockLength )
{
    NATIVE_PROFILE_HAL_DRIVERS_FLASH();
    ...
    //    
BOOL __section(SectionForFlashOperations)STM32F2_Flash_Driver::EraseBlock( void* context, ByteAddress Sector )
{
    NATIVE_PROFILE_HAL_DRIVERS_FLASH();
    ...
    cr |= FLASH_CR_STRT;
    FLASH->CR = cr;
    // asure busy flag is set up (see STM32F2 errata)
    FLASH->CR = cr;
    // wait for completion
    while (FLASH->SR & FLASH_SR_BSY);
    ...
    //
void  __section(SectionForFlashOperations)STM32F2_Flash_Driver::SetPowerState( void* context, UINT32 State )
{
}
...
UINT32 __section(SectionForFlashOperations)STM32F2_Flash_Driver::MaxSectorWrite_uSec( void* context )
{
    NATIVE_PROFILE_PAL_FLASH();
...
UINT32 __section(SectionForFlashOperations)STM32F2_Flash_Driver::MaxBlockErase_uSec( void* context )
{
    NATIVE_PROFILE_PAL_FLASH();
...
#pragma arm section rodata = "g_STM32F2_Flash_DeviceTable"
#endif

struct IBlockStorageDevice g_STM32F2_Flash_DeviceTable = 
{                          
    &STM32F2_Flash_Driver::ChipInitialize,
    &STM32F2_Flash_Driver::ChipUnInitialize,
    &STM32F2_Flash_Driver::GetDeviceInfo,
    &STM32F2_Flash_Driver::Read,
    &STM32F2_Flash_Driver::Write,
    &STM32F2_Flash_Driver::Memset,    
    &STM32F2_Flash_Driver::GetSectorMetadata,
    &STM32F2_Flash_Driver::SetSectorMetadata,
    &STM32F2_Flash_Driver::IsBlockErased,
    &STM32F2_Flash_Driver::EraseBlock,
    &STM32F2_Flash_Driver::SetPowerState,
    &STM32F2_Flash_Driver::MaxSectorWrite_uSec,
    &STM32F2_Flash_Driver::MaxBlockErase_uSec,    
};
