...
#if !defined(STM32F2_I2C_SCL_PIN)
#define STM32F2_I2C_SCL_PIN    26 // PB10
#endif
#if !defined(STM32F2_I2C_SDA_PIN)
#define STM32F2_I2C_SDA_PIN    27 // PB11
#endif
#elsif STM32F2_I2C_PORT == 3
#define I2Cx                   I2C3 
...
#if !defined(STM32F2_I2C_SCL_PIN)
#define STM32F2_I2C_SCL_PIN    8 // PA8
#endif
#if !defined(STM32F2_I2C_SDA_PIN)
#define STM32F2_I2C_SDA_PIN    41 // PC9
#endif
...
void STM32F2_I2C_ER_Interrupt (void* param) // Error Interrupt Handler
{
    INTERRUPT_START
...
void STM32F2_I2C_EV_Interrupt (void* param) // Event Interrupt Handler
{
    INTERRUPT_START
...
BOOL I2C_Internal_Initialize()
{
    ...
    if (!(RCC->APB1ENR & RCC_APB1ENR_I2CxEN)) { // only once
        ...
        CPU_GPIO_DisablePin( STM32F2_I2C_SDA_PIN, RESISTOR_DISABLED, 0, (GPIO_ALT_MODE)0x43 );
        CPU_GPIO_DisablePin( STM32F2_I2C_SCL_PIN, RESISTOR_DISABLED, 0, (GPIO_ALT_MODE)0x43 );
        ...
        CPU_INTC_ActivateInterrupt(I2Cx_EV_IRQn, STM32F2_I2C_EV_Interrupt, 0);
        CPU_INTC_ActivateInterrupt(I2Cx_ER_IRQn, STM32F2_I2C_ER_Interrupt, 0);
    }
...
{
    scl = STM32F2_I2C_SCL_PIN;
    sda = STM32F2_I2C_SDA_PIN;
}
