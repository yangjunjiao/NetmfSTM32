...
#include <tinyhal.h>
#include "STM32F2_Power_functions.h"
...
static void (*g_STM32F2_stopHandler)();
static void (*g_STM32F2_restartHandler)();


void STM32F2_SetPowerHandlers(void (*stop)(), void (*restart)())
{
    g_STM32F2_stopHandler = stop;
    g_STM32F2_restartHandler = restart;
}
...
void CPU_Sleep( SLEEP_LEVEL level, UINT64 wakeEvents )
{
    ...
    case SLEEP_LEVEL__DEEP_SLEEP: // stop
        ...
        if (g_STM32F2_stopHandler != NULL) g_STM32F2_stopHandler();
        ...
        if (g_STM32F2_restartHandler != NULL) g_STM32F2_restartHandler();
        return;
