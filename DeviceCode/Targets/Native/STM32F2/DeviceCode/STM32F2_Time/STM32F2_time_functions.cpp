...
//
#define STM32F2_SLEEP_USEC_FIXED_OVERHEAD_CLOCKS 3
...
void __section(SectionForFlashOperations) HAL_Time_Sleep_MicroSeconds( UINT32 uSec )
{
    ...
    if(maxDiff <= STM32F2_SLEEP_USEC_FIXED_OVERHEAD_CLOCKS) maxDiff  = 0; 
    else maxDiff -= STM32F2_SLEEP_USEC_FIXED_OVERHEAD_CLOCKS;
