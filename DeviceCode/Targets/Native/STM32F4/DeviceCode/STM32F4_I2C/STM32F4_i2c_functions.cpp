...
BOOL I2C_Internal_Initialize()
{
    ...
    if (!(RCC->APB1ENR & RCC_APB1ENR_I2CxEN)) { // only once
        ...
        CPU_GPIO_DisablePin( STM32F4_I2C_SDA_PIN, RESISTOR_DISABLED, 0, (GPIO_ALT_MODE)0x43 );
        CPU_GPIO_DisablePin( STM32F4_I2C_SCL_PIN, RESISTOR_DISABLED, 0, (GPIO_ALT_MODE)0x43 );
