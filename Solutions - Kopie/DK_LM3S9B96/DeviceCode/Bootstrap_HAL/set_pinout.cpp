...
// 
// This is part of revision 5727 of the DK-LM3S9B96 Firmware Package.
//
//*****************************************************************************
...
PortControlSet(tDaughterIDInfo *psInfo)
{
    ...
    // GPIO Port B pins
    //
    ulPctl[1] = GPIO_PCTL_PB0_U1RX      | GPIO_PCTL_PB1_U1TX    |
                GPIO_PCTL_PB2_I2C0SCL   | GPIO_PCTL_PB3_I2C0SDA |
    ...
    // GPIO Port D pins.
    //
    ulPctl[3] = GPIO_PCTL_PD0_U1RX | GPIO_PCTL_PD1_U1TX |
...
PinoutSet(void)
{
    ...
    // development board.
    //
    sDaughterType = DaughterBoardTypeGet(&sInfo);
...
PinoutSet(void)
{
    ...
    // GPIO Port B pins
    //
    HWREG(GPIO_PORTB_BASE + GPIO_O_PCTL) = GPIO_PCTL_PB0_U1RX |
                                           GPIO_PCTL_PB1_U1TX |
