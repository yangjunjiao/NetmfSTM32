...
#define STM32F2_AD_CHANNELS {1,2,3,8,9,14,15} // PA1,PA2,PA3,PB0,PB1,PC4,PC5

#define STM32F2_PWM_TIMER {4,4,4,4,1,1,1,1}
#define STM32F2_PWM_CHNL  {0,1,2,3,0,1,2,3}
#define STM32F2_PWM_PINS  {60,61,62,63,73,75,77,78} // D12-D15,E9,E11,E13,E14

#define STM32F2_SPI_SCLK_PINS {5, 29, 42} // PA5, PB13, PC10
#define STM32F2_SPI_MISO_PINS {6, 30, 43} // PA6, PB14, PC11
#define STM32F2_SPI_MOSI_PINS {7, 31, 44} // PA7, PB15, PC12

#define STM32F2_I2C_PORT     1
#define STM32F2_I2C_SCL_PIN  22 // PB6
#define STM32F2_I2C_SDA_PIN  25 // PB9
