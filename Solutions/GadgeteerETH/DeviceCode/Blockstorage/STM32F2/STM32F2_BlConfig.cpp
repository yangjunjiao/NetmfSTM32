...
//
//  *** GadgeteerETH Block Storage Configuration ***
//
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
#define STM32F2__CHIP_SELECT       0
#define STM32F2__WAIT_STATES       5 // not used
#define STM32F2__RELEASE_COUNTS    0
#define STM32F2__BIT_WIDTH         16
#define STM32F2__BASE_ADDRESS      0x08000000
#define STM32F2__SIZE_IN_BYTES     0x00100000 
#define STM32F2__WP_GPIO_PIN       GPIO_PIN_NONE
#define STM32F2__WP_ACTIVE         FALSE
...
#define STM32F2__IS_REMOVABLE      FALSE
#define STM32F2__SUPPORTS_XIP      TRUE
#define STM32F2__WRITE_PROTECTED   FALSE
#define STM32F2__SUPP_COPY_BACK    FALSE
#define STM32F2__NUM_REGIONS       3
...
const BlockRegionInfo  g_STM32F2_BlkRegion[STM32F2__NUM_REGIONS] = 
{
    ...
    
    {
        ...
        ARRAYSIZE_CONST_EXPR(g_STM32F2_BlockRange3),
        g_STM32F2_BlockRange3,
    }
};
...
const BlockDeviceInfo g_STM32F2_DeviceInfo=
{
    {  
        STM32F2__IS_REMOVABLE,             // BOOL Removable;
        STM32F2__SUPPORTS_XIP,             // BOOL SupportsXIP;
        STM32F2__WRITE_PROTECTED,          // BOOL WriteProtected;
        STM32F2__SUPP_COPY_BACK            // BOOL SupportsCopyBack
    },
    ...
    STM32F2__NUM_REGIONS,                  // UINT32 NumRegions;
    g_STM32F2_BlkRegion,                   // const BlockRegionInfo* pRegions;
};


struct MEMORY_MAPPED_NOR_BLOCK_CONFIG g_STM32F2_BS_Config =
{
    { // BLOCK_CONFIG
        {
            STM32F2__WP_GPIO_PIN,          // GPIO_PIN             Pin;
            STM32F2__WP_ACTIVE,            // BOOL                 ActiveState;
        },

        &g_STM32F2_DeviceInfo,             // BlockDeviceinfo
    },

    { // CPU_MEMORY_CONFIG
        STM32F2__CHIP_SELECT,              // UINT8  CPU_MEMORY_CONFIG::ChipSelect;
        TRUE,                              // UINT8  CPU_MEMORY_CONFIG::ReadOnly;
        STM32F2__WAIT_STATES,              // UINT32 CPU_MEMORY_CONFIG::WaitStates;
        STM32F2__RELEASE_COUNTS,           // UINT32 CPU_MEMORY_CONFIG::ReleaseCounts;
        STM32F2__BIT_WIDTH,                // UINT32 CPU_MEMORY_CONFIG::BitWidth;
        STM32F2__BASE_ADDRESS,             // UINT32 CPU_MEMORY_CONFIG::BaseAddress;
        STM32F2__SIZE_IN_BYTES,            // UINT32 CPU_MEMORY_CONFIG::SizeInBytes;
...
#pragma arm section rodata = "g_STM32F2_BS"
#endif

struct BlockStorageDevice g_STM32F2_BS;
