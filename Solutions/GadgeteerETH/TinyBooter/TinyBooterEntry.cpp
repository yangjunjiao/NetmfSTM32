...
//
//  Customized for GadgeteerETH board
//
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
#define BOOTER_BUTTON_PIN (1 * 16 + 14) // B14

#define BOOTER_LED_PIN (1 * 16 + 15) // PB15
...
bool WaitForTinyBooterUpload( INT32 &timeout_ms )
{
    ...
    timeout_ms = -1;
#else
    CPU_GPIO_EnableInputPin( BOOTER_BUTTON_PIN, FALSE, NULL, GPIO_INT_NONE, RESISTOR_PULLUP );
    if(!CPU_GPIO_GetPinState( BOOTER_BUTTON_PIN ))
    {
...
void TinyBooter_OnStateChange( TinyBooterState state, void* data, void ** retData )
{
    switch(state)
    {
        ...
        case State_EnterBooterMode:
            CPU_GPIO_EnableOutputPin(BOOTER_LED_PIN, TRUE);
