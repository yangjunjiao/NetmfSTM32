...
#ifndef _PLATFORM_SAM7X_EK_SELECTOR_H_
#define _PLATFORM_SAM7X_EK_SELECTOR_H_ 1
...
#define HAL_SYSTEM_NAME             "SAM7X_EK"
...
#define PLATFORM_DEPENDENT_USB_QUEUE_PACKET_COUNT    16  // there is one queue for each pipe of each endpoint and the size of a single packet is sizeof(USB_PACKET64) == 68 bytes
//
// communicaiton facilities
/////////////////////////////////////////////////////////
...
#endif // PLATFORM_ARM_SAM7X_EK
#endif // _PLATFORM_SAM7X_EK_SELECTOR_H_
