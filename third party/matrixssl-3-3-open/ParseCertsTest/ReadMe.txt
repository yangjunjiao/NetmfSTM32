========================================================================
    KONSOLENANWENDUNG: ParseCertsTest-Projektübersicht
========================================================================

Diese ParseCertsTest-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre ParseCertsTest-Anwendung besteht.


ParseCertsTest.vcxproj
...
ParseCertsTest.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "ParseCertsTest.pch und eine 
